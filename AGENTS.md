# authz-biscuit Canonical Agent Rules

Biscuit deny-by-default authorization crate (couche 3). The
`vendored/authz/` directory is a **verified projection** of the `contracts`
